...
walkingChallenges += ["Walk around Wolf Lake", "Walk the bike trail"]
runningChallenges += ["Run 5 miles in under an hour", "run 5 miles non-stop"]
print(walkingChallenges, runningChallenges)
...
if(committedChallenges.isEmpty){
    ...
    print(" The challenge you have chose in \(committedChallenges[0]) ")
} else {
