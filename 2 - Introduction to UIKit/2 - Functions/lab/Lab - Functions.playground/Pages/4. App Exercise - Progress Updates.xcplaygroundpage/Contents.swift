...
func progressUpdate(steps : Int, goal : Int){
    ...
    else if(steps < goal/100 * 90 && steps > goal/100 * 50){
        print("You over halfway there!")
    }
...
/* test */
progressUpdate(steps: 999, goal: goal)
progressUpdate(steps: 1001, goal: goal)
progressUpdate(steps: 5001, goal: goal)
progressUpdate(steps: 9999, goal: goal)
progressUpdate(steps: 10_001, goal: goal)
...
/* test */
pacing(currentDIstance: 2.5, totalDistance: 10, currentTime: 10, goalTime: 10)
pacing(currentDIstance: 1, totalDistance: 10, currentTime: 1, goalTime: 11)
