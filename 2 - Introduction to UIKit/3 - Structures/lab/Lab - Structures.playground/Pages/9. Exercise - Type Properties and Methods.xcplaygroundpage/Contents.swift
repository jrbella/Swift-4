...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Jeffrey", email: "jbella@icstars.org", age: 31)
 ...
 */
var newUser = User(userName: "Dave", email: "dwill@gmail.com", age: 22)
print(User.logIn(newUser))
