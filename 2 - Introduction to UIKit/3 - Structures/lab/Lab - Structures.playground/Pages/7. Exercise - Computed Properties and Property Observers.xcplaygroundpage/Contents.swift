...
print("My rectangle height is \(myRectangle.height) inches and the width is \(myRectangle.width) inches")
...
struct Height {
    ...
    var heightInInches: Double {
        willSet {
            print("Checking heightInCentimeters  currently \(heightInCentimeters)")
        }
        didSet {
            if (heightInInches != oldValue){
                print("Changed heightInCentimeters to \(heightInCentimeters)")
            }
        }
    }
    var heightInCentimeters: Double {
        willSet {
            print("Checking heightInInches  currently \(heightInInches)")
        }
        didSet{
            print("Changed heightInInches to \(heightInInches)")
        }
    }
...
var myHeight = Height(heightInCentimeters: 155)
print(myHeight)
